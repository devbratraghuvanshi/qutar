...
namespace qatarpayment
{
    ...
    public class VPCRequest
    {
        ...
        public VPCRequest()
        {
            ...
            _address = new Uri(utilityclass.url_payment);// new Uri(appSettings["PaymentServerURL"]);
            _merchantID = utilityclass.MerchentID;// appSettings["vpc_Merchant"];
            _accessCode = utilityclass.Access_Code;// appSettings["vpc_AccessCode"];
            _vpcCommand = utilityclass.Command_Type;// appSettings["vpc_Command"];
            _vpcVersion = utilityclass.VPC_Version;// appSettings["vpc_Version"];
            _returnURL = utilityclass.responce_url;// appSettings["vpc_ReturnURL"];
            _secureSecret = utilityclass.Secure_key;// appSettings["SecureSecret"];
        }
